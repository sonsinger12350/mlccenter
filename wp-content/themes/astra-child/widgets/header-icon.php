...
class Astra_Child_Custom_Widget_Header_Icon extends WP_Widget {
    ...
    public function widget($args, $instance) {
		...
		if (!empty($instance['address'])) {
			...
			echo '<a href="https://www.google.com/maps/search/' . esc_html($instance['address']) . '" target="_blank">' . esc_html($instance['address']) . '</a>';
			echo '</div>';
		}
		...
		if (!empty($instance['hotline'])) {
			...
			echo '<a href="tel:' . esc_html($instance['hotline']) . '">' . esc_html($instance['hotline']) . '</a>';
			echo '</div>';
		}
